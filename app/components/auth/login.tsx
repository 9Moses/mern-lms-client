  ...
  return (
    <div className='w-full'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className='flex items-center justify-center my-3'>
            <p className='dark:text-white text-black text-center pt-4 text-[14px]'>Don't have an account? 
            <span onClick={() => setRoute("Sign-Up")} className='text-[#39c1f3] pl-1 cursor-pointer'>Sign Up</span>
            </p>
